  ...
  try {
    ...
    if (raw) {
      ...
      return {
        ...
        scrollPosition: Number.isFinite(parsed.scrollPosition) ? Math.max(0, parsed.scrollPosition) : 0,
        topVisibleStatusOffset: Number.isFinite(parsed.topVisibleStatusOffset)
          ? parsed.topVisibleStatusOffset
          : 0,
